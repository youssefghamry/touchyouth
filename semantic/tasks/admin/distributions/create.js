      ...
      if(distribution == 'CSS') {
        ...
        gulp.task(task.repo, function() {
          var
            ...
            themes
          ;
          definitions = gulp.src('keuangan/definitions/**/*', { base: 'keuangan/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themeImport = gulp.src('keuangan/semantic.less', { base: 'keuangan/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themeImport = gulp.src('keuangan/theme.less', { base: 'keuangan/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themeConfig = gulp.src('keuangan/theme.config.example', { base: 'keuangan/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          siteTheme = gulp.src('keuangan/_site/**/*', { base: 'keuangan/' })
            .pipe(gulp.dest(outputDirectory))
          ;
          themes = gulp.src('keuangan/themes/**/*', { base: 'keuangan/' })
            .pipe(gulp.dest(outputDirectory))
          ;
