...
gulp.task('create install files', function(callback) {
  ...
  gulp.task('create theme.config', function() {
    ...
    if(fs.existsSync(installPaths.themeConfig)) {
      console.info('Modifying keuangan/theme.config (LESS config)', installPaths.themeConfig);
      ...
      console.info('Creating keuangan/theme.config (LESS config)', installPaths.themeConfig);
