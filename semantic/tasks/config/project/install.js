...
module.exports = {
  ...
  source: {
    ...
    lessImport   : './keuangan/semantic.less',
    site         : './keuangan/_site',
    tasks        : './tasks',
    themeConfig  : './keuangan/theme.config.example',
    themeImport  : './keuangan/theme.less',
    themes       : './keuangan/themes',
    defaultTheme : './keuangan/themes/default',
  ...
  files: {
    ...
    lessImport  : 'keuangan/semantic.less',
    site        : 'keuangan/site',
    themeConfig : 'keuangan/theme.config',
    themeImport : 'keuangan/theme.less'
  },
  ...
  folders: {
    ...
    site         : 'keuangan/site/',
    tasks        : 'tasks/',
    themeConfig  : 'keuangan/',
    themeImport  : 'keuangan/',
    themes       : 'keuangan/themes/',
    ...
    setup: [
      ...
      },
      {
        ...
        choices: [
          ...
          {
            name: 'Custom (Customize all keuangan/dist values)',
            value: 'custom'
          }
        ]
      },
